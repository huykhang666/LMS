...
export function Error403Page() {
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-paper px-4 text-center">
      ...
      <h1 className="font-display text-3xl font-extrabold text-ink sm:text-4xl">Truy cập bị từ chối</h1>
      <p className="mt-2 text-ink-soft max-w-md">
        Bạn không có quyền hạn truy cập vào khu vực này. Vui lòng quay lại trang chủ hoặc liên hệ quản trị viên.
      </p>
      <Link
        to="/"
